...
class Tizen80CapiMediaStreamrecorder {
  ...
  late final _streamrecorder_push_stream_bufferPtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(streamrecorder_h, media_packet_h)>>(
      'streamrecorder_push_stream_buffer');
  late final _streamrecorder_push_stream_buffer =
      _streamrecorder_push_stream_bufferPtr
          .asFunction<int Function(streamrecorder_h, media_packet_h)>();
