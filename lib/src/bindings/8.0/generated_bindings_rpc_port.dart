...
class Tizen80RpcPort {
  ...
  late final _rpc_port_parcel_write_bundlePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(rpc_port_parcel_h,
              ffi.Pointer<bundle>)>>('rpc_port_parcel_write_bundle');
  late final _rpc_port_parcel_write_bundle = _rpc_port_parcel_write_bundlePtr
      .asFunction<int Function(rpc_port_parcel_h, ffi.Pointer<bundle>)>();
  ...
  late final _rpc_port_parcel_read_bundlePtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  rpc_port_parcel_h, ffi.Pointer<ffi.Pointer<bundle>>)>>(
      'rpc_port_parcel_read_bundle');
  late final _rpc_port_parcel_read_bundle =
      _rpc_port_parcel_read_bundlePtr.asFunction<
          int Function(rpc_port_parcel_h, ffi.Pointer<ffi.Pointer<bundle>>)>();
  ...
  int rpc_port_parcel_header_get_timestamp(
    rpc_port_parcel_header_h header,
    ffi.Pointer<timespec> timestamp,
  ) {
  ...
  late final _rpc_port_parcel_header_get_timestampPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(rpc_port_parcel_header_h,
              ffi.Pointer<timespec>)>>('rpc_port_parcel_header_get_timestamp');
  late final _rpc_port_parcel_header_get_timestamp =
      _rpc_port_parcel_header_get_timestampPtr.asFunction<
          int Function(rpc_port_parcel_header_h, ffi.Pointer<timespec>)>();
