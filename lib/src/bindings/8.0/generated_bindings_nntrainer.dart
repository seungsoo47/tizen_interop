...
/// Dart bindings for Tizen nntrainer APIs.
class Tizen80Nntrainer {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen80Nntrainer(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen80Nntrainer.fromLookup(
  ...
  late final _ml_train_model_get_input_tensors_infoPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  ml_train_model_h, ffi.Pointer<ml_tensors_info_h>)>>(
  ...
  late final _ml_train_model_get_input_tensors_info =
      _ml_train_model_get_input_tensors_infoPtr.asFunction<
          int Function(ml_train_model_h, ffi.Pointer<ml_tensors_info_h>)>();
  ...
  int ml_train_model_get_weight(
    ml_train_model_h model,
    ffi.Pointer<ffi.Char> layer_name,
    ffi.Pointer<ml_tensors_data_h> weight,
    ffi.Pointer<ml_tensors_info_h> info,
  ) {
  ...
  late final _ml_train_model_get_weightPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<ml_tensors_info_h>)>>('ml_train_model_get_weight');
