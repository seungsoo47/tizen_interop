...
class Tizen80Mv_Common {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen80Mv_Common(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen80Mv_Common.fromLookup(
  ...
  late final _mv_source_fill_by_media_packetPtr = _lookup<
          ffi.NativeFunction<ffi.Int Function(mv_source_h, media_packet_h)>>(
      'mv_source_fill_by_media_packet');
  late final _mv_source_fill_by_media_packet =
      _mv_source_fill_by_media_packetPtr
          .asFunction<int Function(mv_source_h, media_packet_h)>();
