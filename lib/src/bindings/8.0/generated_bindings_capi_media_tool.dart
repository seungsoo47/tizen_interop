...
class Tizen80CapiMediaTool {
  ...
  late final _media_packet_new_from_tbm_surface =
      _media_packet_new_from_tbm_surfacePtr.asFunction<
          int Function(media_format_h, tbm_surface_h, media_packet_dispose_cb,
              ffi.Pointer<ffi.Void>, ffi.Pointer<media_packet_h>)>();
  ...
  late final _media_packet_create_from_tbm_surface =
      _media_packet_create_from_tbm_surfacePtr.asFunction<
          int Function(media_format_h, tbm_surface_h, media_packet_finalize_cb,
              ffi.Pointer<ffi.Void>, ffi.Pointer<media_packet_h>)>();
  ...
  late final _media_packet_get_tbm_surfacePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(media_packet_h,
              ffi.Pointer<tbm_surface_h>)>>('media_packet_get_tbm_surface');
  late final _media_packet_get_tbm_surface = _media_packet_get_tbm_surfacePtr
      .asFunction<int Function(media_packet_h, ffi.Pointer<tbm_surface_h>)>();
