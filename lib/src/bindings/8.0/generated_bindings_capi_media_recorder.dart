...
class Tizen80CapiMediaRecorder {
  ...
  late final _recorder_create_videorecorderPtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(camera_h, ffi.Pointer<recorder_h>)>>(
      'recorder_create_videorecorder');
  late final _recorder_create_videorecorder = _recorder_create_videorecorderPtr
      .asFunction<int Function(camera_h, ffi.Pointer<recorder_h>)>();
  ...
  late final _recorder_set_sound_stream_infoPtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(recorder_h, sound_stream_info_h)>>(
      'recorder_set_sound_stream_info');
  late final _recorder_set_sound_stream_info =
      _recorder_set_sound_stream_infoPtr
          .asFunction<int Function(recorder_h, sound_stream_info_h)>();
