...
class Tizen80Diagnostics {
  ...
  late final _diagnostics_send_eventPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>,
              ffi.Pointer<bundle>)>>('diagnostics_send_event');
  late final _diagnostics_send_event = _diagnostics_send_eventPtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<bundle>)>();
  ...
  int diagnostics_get_event_data(
    diagnostics_ctx_h ctx,
    ffi.Pointer<ffi.Pointer<bundle>> event_data,
  ) {
  ...
  late final _diagnostics_get_event_dataPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(diagnostics_ctx_h,
              ffi.Pointer<ffi.Pointer<bundle>>)>>('diagnostics_get_event_data');
  late final _diagnostics_get_event_data =
      _diagnostics_get_event_dataPtr.asFunction<
          int Function(diagnostics_ctx_h, ffi.Pointer<ffi.Pointer<bundle>>)>();
