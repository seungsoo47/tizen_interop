...
class Tizen80CsrClient {
  ...
  late final _csr_engine_get_latest_update_timePtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(csr_engine_h, ffi.Pointer<time_t>)>>(
      'csr_engine_get_latest_update_time');
  late final _csr_engine_get_latest_update_time =
      _csr_engine_get_latest_update_timePtr
          .asFunction<int Function(csr_engine_h, ffi.Pointer<time_t>)>();
  ...
  late final _csr_cs_malware_get_timestampPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(csr_cs_malware_h,
              ffi.Pointer<time_t>)>>('csr_cs_malware_get_timestamp');
  late final _csr_cs_malware_get_timestamp = _csr_cs_malware_get_timestampPtr
      .asFunction<int Function(csr_cs_malware_h, ffi.Pointer<time_t>)>();
