...
class Tizen80Mv_Inference {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen80Mv_Inference(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen80Mv_Inference.fromLookup(
  ...
  late final _mv_inference_configurePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              mv_inference_h, mv_engine_config_h)>>('mv_inference_configure');
  late final _mv_inference_configure = _mv_inference_configurePtr
      .asFunction<int Function(mv_inference_h, mv_engine_config_h)>();
  ...
  late final _mv_inference_image_classify =
      _mv_inference_image_classifyPtr.asFunction<
          int Function(mv_source_h, mv_inference_h, ffi.Pointer<mv_rectangle_s>,
              mv_inference_image_classified_cb, ffi.Pointer<ffi.Void>)>();
  ...
  late final _mv_inference_object_detect =
      _mv_inference_object_detectPtr.asFunction<
          int Function(mv_source_h, mv_inference_h,
  ...
  late final _mv_inference_pose_landmark_detect =
      _mv_inference_pose_landmark_detectPtr.asFunction<
          int Function(mv_source_h, mv_inference_h, ffi.Pointer<mv_rectangle_s>,
              mv_inference_pose_landmark_detected_cb, ffi.Pointer<ffi.Void>)>();
  ...
  late final _mv_inference_pose_get_landmark =
      _mv_inference_pose_get_landmarkPtr.asFunction<
          int Function(mv_inference_pose_result_h, int, int,
              ffi.Pointer<mv_point_s>, ffi.Pointer<ffi.Float>)>();
