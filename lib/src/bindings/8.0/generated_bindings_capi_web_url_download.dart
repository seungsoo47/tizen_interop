...
class Tizen80CapiWebUrlDownload {
  ...
  late final _download_set_notification_app_controlPtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(ffi.Int, ffi.Int32, app_control_h)>>(
  ...
  late final _download_set_notification_app_control =
      _download_set_notification_app_controlPtr
          .asFunction<int Function(int, int, app_control_h)>();
  ...
  late final _download_get_notification_app_controlPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  ffi.Int, ffi.Int32, ffi.Pointer<app_control_h>)>>(
      'download_get_notification_app_control');
  late final _download_get_notification_app_control =
      _download_get_notification_app_controlPtr
          .asFunction<int Function(int, int, ffi.Pointer<app_control_h>)>();
