...
class Tizen65Mv_Image {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen65Mv_Image(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen65Mv_Image.fromLookup(
  ...
  late final _mv_image_recognize = _mv_image_recognizePtr.asFunction<
      int Function(mv_source_h, ffi.Pointer<mv_image_object_h>, int,
          mv_engine_config_h, mv_image_recognized_cb, ffi.Pointer<ffi.Void>)>();
  ...
  late final _mv_image_track = _mv_image_trackPtr.asFunction<
      int Function(mv_source_h, mv_image_tracking_model_h, mv_engine_config_h,
          mv_image_tracked_cb, ffi.Pointer<ffi.Void>)>();
  ...
  late final _mv_image_object_fillPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_image_object_h, mv_engine_config_h, mv_source_h,
              ffi.Pointer<mv_rectangle_s>)>>('mv_image_object_fill');
  late final _mv_image_object_fill = _mv_image_object_fillPtr.asFunction<
      int Function(mv_image_object_h, mv_engine_config_h, mv_source_h,
  ...
  late final _mv_image_tracking_model_refreshPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_image_tracking_model_h,
              mv_engine_config_h)>>('mv_image_tracking_model_refresh');
  late final _mv_image_tracking_model_refresh =
      _mv_image_tracking_model_refreshPtr.asFunction<
          int Function(mv_image_tracking_model_h, mv_engine_config_h)>();
...
typedef mv_image_recognized_cbFunction = ffi.Void Function(
    ...
    mv_engine_config_h engine_cfg,
    ffi.Pointer<mv_image_object_h> image_objects,
    ffi.Pointer<ffi.Pointer<mv_quadrangle_s>> locations,
