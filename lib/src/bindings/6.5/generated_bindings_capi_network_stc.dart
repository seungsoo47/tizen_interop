...
class Tizen65CapiNetworkStc {
  ...
  late final _stc_stats_rule_set_time_intervalPtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(stc_stats_rule_h, time_t, time_t)>>(
  ...
  late final _stc_stats_rule_get_time_intervalPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(stc_stats_rule_h, ffi.Pointer<time_t>,
              ffi.Pointer<time_t>)>>('stc_stats_rule_get_time_interval');
  late final _stc_stats_rule_get_time_interval =
      _stc_stats_rule_get_time_intervalPtr.asFunction<
          int Function(
              stc_stats_rule_h, ffi.Pointer<time_t>, ffi.Pointer<time_t>)>();
  ...
  late final _stc_stats_info_get_time_intervalPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(stc_stats_info_h, ffi.Pointer<time_t>,
              ffi.Pointer<time_t>)>>('stc_stats_info_get_time_interval');
  late final _stc_stats_info_get_time_interval =
      _stc_stats_info_get_time_intervalPtr.asFunction<
          int Function(
              stc_stats_info_h, ffi.Pointer<time_t>, ffi.Pointer<time_t>)>();
