  ...
  late final _mc_search_set_conditionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<bundle>)>>('mc_search_set_condition');
  late final _mc_search_set_condition = _mc_search_set_conditionPtr.asFunction<
      int Function(
          mc_search_h, int, int, ffi.Pointer<ffi.Char>, ffi.Pointer<bundle>)>();
  ...
  late final _mc_client_send_event_replyPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.Int,
              ffi.Pointer<bundle>)>>('mc_client_send_event_reply');
