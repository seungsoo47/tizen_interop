...
class Tizen70Mv_Face {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen70Mv_Face(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen70Mv_Face.fromLookup(
  ...
  late final _mv_face_detectPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_source_h, mv_engine_config_h, mv_face_detected_cb,
              ffi.Pointer<ffi.Void>)>>('mv_face_detect');
  late final _mv_face_detect = _mv_face_detectPtr.asFunction<
      int Function(mv_source_h, mv_engine_config_h, mv_face_detected_cb,
  ...
  late final _mv_face_track = _mv_face_trackPtr.asFunction<
      int Function(mv_source_h, mv_face_tracking_model_h, mv_engine_config_h,
          mv_face_tracked_cb, bool, ffi.Pointer<ffi.Void>)>();
  ...
  late final _mv_face_eye_condition_recognize =
      _mv_face_eye_condition_recognizePtr.asFunction<
          int Function(mv_source_h, mv_engine_config_h, mv_rectangle_s,
              mv_face_eye_condition_recognized_cb, ffi.Pointer<ffi.Void>)>();
  ...
  late final _mv_face_recognition_model_add =
      _mv_face_recognition_model_addPtr.asFunction<
          int Function(mv_source_h, mv_face_recognition_model_h,
              ffi.Pointer<mv_rectangle_s>, int)>();
  ...
  late final _mv_face_recognition_model_learnPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_engine_config_h,
  ...
  late final _mv_face_recognition_model_learn =
      _mv_face_recognition_model_learnPtr.asFunction<
          int Function(mv_engine_config_h, mv_face_recognition_model_h)>();
  ...
  late final _mv_face_tracking_model_preparePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              mv_engine_config_h,
              mv_source_h,
              ffi.Pointer<mv_quadrangle_s>)>>('mv_face_tracking_model_prepare');
  late final _mv_face_tracking_model_prepare =
      _mv_face_tracking_model_preparePtr.asFunction<
          int Function(mv_face_tracking_model_h, mv_engine_config_h,
              mv_source_h, ffi.Pointer<mv_quadrangle_s>)>();
...
typedef mv_face_detected_cbFunction = ffi.Void Function(
    mv_source_h source,
    mv_engine_config_h engine_cfg,
    ffi.Pointer<mv_rectangle_s> faces_locations,
