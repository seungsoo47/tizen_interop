...
/// Dart bindings for Tizen mv-3d APIs.
class Tizen70Mv3D {
  ...
  late final _mv_3d_configurePtr = _lookup<
          ffi.NativeFunction<ffi.Int Function(mv_3d_h, mv_engine_config_h)>>(
      'mv_3d_configure');
  late final _mv_3d_configure = _mv_3d_configurePtr
      .asFunction<int Function(mv_3d_h, mv_engine_config_h)>();
  ...
  late final _mv_3d_runPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              mv_3d_h, mv_source_h, mv_source_h, mv_source_h)>>('mv_3d_run');
  late final _mv_3d_run = _mv_3d_runPtr.asFunction<
      int Function(mv_3d_h, mv_source_h, mv_source_h, mv_source_h)>();
  ...
  late final _mv_3d_run_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_3d_h, mv_source_h, mv_source_h,
              mv_source_h)>>('mv_3d_run_async');
...
typedef mv_3d_pointcloud_cbFunction = ffi.Void Function(mv_source_h source,
    mv_3d_pointcloud_h pointcloud, ffi.Pointer<ffi.Void> user_data);
typedef Dartmv_3d_pointcloud_cbFunction = void Function(mv_source_h source,
    mv_3d_pointcloud_h pointcloud, ffi.Pointer<ffi.Void> user_data);
