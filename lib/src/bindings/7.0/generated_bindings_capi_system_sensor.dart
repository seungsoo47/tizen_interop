...
class Tizen70CapiSystemSensor {
  ...
  late final _sensor_recorder_query_set_timePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(sensor_recorder_query_h, ffi.Int32,
              time_t)>>('sensor_recorder_query_set_time');
  ...
  late final _sensor_recorder_data_get_timePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(sensor_recorder_data_h, ffi.Pointer<time_t>,
              ffi.Pointer<time_t>)>>('sensor_recorder_data_get_time');
  late final _sensor_recorder_data_get_time =
      _sensor_recorder_data_get_timePtr.asFunction<
          int Function(sensor_recorder_data_h, ffi.Pointer<time_t>,
              ffi.Pointer<time_t>)>();
